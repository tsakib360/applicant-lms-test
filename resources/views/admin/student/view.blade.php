                        ...
                        <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-stack fs-4 py-3">
                                    ...
                                    <button class="btn btn-sm btn-light-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">
                                        Edit
                                    </button>
                                </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content rounded">
                                            ...
                                            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                <!--begin:Form-->
                                                <form id="kt_modal_new_target_form" class="form" action="{{ route('admin.student.update', @$student->id) }}" method="post">
                                                @csrf
                                                    {{ method_field('PUT') }}
                                                <!--begin::Heading-->
                                                    ...
                                                    <div class="d-flex flex-column mb-8 fv-row">
                                                        ...
                                                        <!--end::Label-->
                                                        <input type="text" class="form-control form-control-solid" placeholder="Enter First Name" name="first_name" value="{{ $student->first_name }}" required/>
                                                    </div>
                                                    <!--end::Input group-->
                                                    <!--begin::Input group-->
                                                    <div class="d-flex flex-column mb-8 fv-row">
                                                        ...
                                                        <!--end::Label-->
                                                        <input type="text" class="form-control form-control-solid" placeholder="Enter Last Name" name="last_name" value="{{ $student->last_name }}" required/>
                                                    </div>
                                                    <!--end::Input group-->
                                                    <!--begin::Input group-->
                                                    <div class="d-flex flex-column mb-8 fv-row">
                                                        ...
                                                        <!--end::Label-->
                                                        <input type="email" class="form-control form-control-solid" placeholder="Enter Email" name="email" value="{{ $student->email }}" required/>
                                                    </div>
                                                    <!--end::Input group-->
                                                    <!--begin::Input group-->
{{--                                                    <div class="d-flex flex-column mb-8 fv-row">--}}
...
{{--                                                        <!--begin::Label-->--}}
{{--                                                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">--}}
{{--                                                            <span class="">Password Confirmation</span>--}}
{{--                                                        </label>--}}
{{--                                                        <!--end::Label-->--}}
                                ...
                                <div class="card card-flush mb-6 mb-xl-9">
                                    ...
                                    <div class="card-header mt-6">
                                        ...
                                        <div class="card-title flex-column">
                                            <h2 class="mb-1">Student's Courses</h2>
                                        </div>
                                        <!--end::Card title-->
                                    </div>
                                    <!--end::Card header-->
